...
1. Research facts
2. Write narration draft (50-150 words, hook + body + closing question)
...
**Lesson**: Use `text_to_speech` tool (OpenAI TTS via Nous subscription) as primary TTS. It works reliably and produces ~39s audio for ~150 words.

## Updated Workflow for This User

```
1. Research & fact-gather
2. Write narration draft (50-150 words)
