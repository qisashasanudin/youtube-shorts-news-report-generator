...
The builder's `_check_subtitle_words()` enforces **50-100 words** (despite some comments mentioning 100-200). Our narration required trimming from ~127 → ~100 words. Track exact count: `len(subtitle.split())`.
